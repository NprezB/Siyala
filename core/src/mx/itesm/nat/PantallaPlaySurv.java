...
public class PantallaPlaySurv extends Pantalla {
    ...
    private final mx.itesm.nat.Siyala juego;
    ...
    private mx.itesm.nat.Objeto botonSwitch;
    ...
    public PantallaPlaySurv(mx.itesm.nat.Siyala juego) {
        this.juego = juego;
    ...
    public void show() {
        ...
        botonSwitch = new mx.itesm.nat.Objeto(texturaSwitch,camara.position.x-350,camara.position.y-300);
