    ...
    private void crearObjetos() {
        ...
        btnInstr.addListener(new ClickListener() {
            public void clicked(InputEvent event, float x, float y) {
                ...
                juego.setScreen(new PantallaCarga(juego, mx.itesm.nat.Pantallas.INSTRUCCIONES));
            }
        });
        ...
        btnSetts.addListener(new ClickListener() {
            public void clicked(InputEvent event, float x, float y) {
                juego.setScreen(new PantallaCarga(juego, mx.itesm.nat.Pantallas.SETTS));
            }
        });
        ...
        btnPlayHist.addListener(new ClickListener(){
            public void clicked(InputEvent event,float x,float y){
                ...
                juego.setScreen(new PantallaCarga(juego, mx.itesm.nat.Pantallas.CREDITOS));
            }
        });
        ...
        btnPlaySurv.addListener(new ClickListener(){
            public void clicked(InputEvent event,float x, float y){
                juego.setScreen(new PantallaCarga(juego, mx.itesm.nat.Pantallas.PLAYSURV));
            }
        ...
        btnCred.addListener(new ClickListener(){
            public void clicked(InputEvent event,float x, float y){
                juego.setScreen(new PantallaCarga(juego, mx.itesm.nat.Pantallas.NIVELES));
            }
